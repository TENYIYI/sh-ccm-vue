	...
	<div class="mainbody">
		...
		<div class="serach_content">
			...
			<el-table :data="tableData" stripe style="width: 100%">
				<el-table-column prop="num" label="序号" min-width="15.3%"></el-table-column>
				<el-table-column prop="user" label="操作用户" min-width="50%"></el-table-column>
				<el-table-column prop="media" label="关闭数" min-width="34.3%"></el-table-column>
			...
			<div class="remarks">
				<i></i>
				<span>备注:</span>
				<span>统计XXXX年X月X日至XXXX年X月X日内的用户关闭数据情况。</span>
			</div>
			<!--备注end-->
		</div>
		<!--传播关闭记录内容end-->
