  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <div class="frombox">
        ...
        <div class="row yanzheng" prop="vercode">
          <span class="svg-container">
            <i class="cercod" />
          </span>
          <!-- <img :src="loginForm.yanzhengma" class="yanzhengma" alt=""> -->
          <img src="@/assets/images/yanzhengma.png" class="yanzhengma" alt="">

          <el-input ref="username" v-model="loginForm.vercode" placeholder="请输入验证码" name="vercode" type="text"
            tabindex="1" auto-complete="on" />
        </div>
        <div class="toolbar">
          <a href="" class="ccm_link">忘记密码?</a>
...
<style lang="scss" scoped>
  ...
  .login-container {
    ...
    .svg-container {
      ...
      .user {
        background-image: url(../../assets/images/ico_ren.png);
      }

      .password {
        background-image: url(../../assets/images/ico_suo.png);
      }

      .cercod {
        background-image: url(../../assets/images/ico_dun.png);
      }
