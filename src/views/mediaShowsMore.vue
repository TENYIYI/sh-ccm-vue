<template>
  <div class="mainbody">
    <div class="serach_bar">
      ...
      <!-- 第一行 -->
      <div class="one_line">
        <span class="medioType current_type">解放日报</span>
        <span class="medioType">文汇报</span>
        <span class="medioType">新民晚报</span>
        <span class="medioType">新闻晨报</span>
        <span class="medioType">澎湃新闻</span>
        <span class="medioType">界面</span>
      </div>
      <!-- 二次搜索结果行 -->
      <div class="two_line">
        <div class="line_left">
