<template>
	<div class="mainbody">
		...
		<div class="serach_bar">
			...
			<!--<el-select v-model="value1" placeholder="请选择用户名">
		...
		<div class="serach_content">
			...
			<el-table :data="tableData" stripe style="width: 100%">
				<el-table-column prop="num" label="序号" min-width="12.972%" align="center"></el-table-column>
				<el-table-column prop="title" label="文章标题" min-width="38.365%"></el-table-column>
				<el-table-column prop="media" label="媒体" min-width="16.037%"></el-table-column>
				<el-table-column prop="user" label="操纵用户" min-width="15.880%"></el-table-column>
				<el-table-column prop="closeTime" label="关闭时间" min-width="16.666%"></el-table-column>
			</el-table>
			<!--查询解决表格end-->
			<!--分页start-->
