<template>
	<div class="mainbody_query">
		...
		<div class="serach_bar_query">
			...
			<span class="title_yuan1">源媒体</span>
				<el-select v-model="value1" multiple placeholder="请选择用户名">
		...
		<div class="serach_content">
			<div class="serach_content_title">
				<div class="serach_content_title_left">
					<span class="search_all">全部</span>
					<span class="search_other">昨天</span>
					<span class="search_other">今天</span>
					<span class="search_other">上周</span>
					<span class="search_other">上月</span>
					<span class="search_other">一季度</span>
					<span class="search_other">半年</span>
					<span class="search_other">一年</span>
				</div>
				<div class="serach_content_title_right">
					<span>导出传播次数</span>
					<span>导出传播明细</span>
				</div>
			</div>
			...
			<el-table :data="tableData" stripe style="width: 100%">
				...
				<el-table-column label="排名" min-width="14.6%"  >
...
.mainbody_query .serach_content_title div{
	display: inline-block
}
...
.media_tabs{
 ...
 .el-table tr td:nth-child(3) .cell img{
  ...
  table tr:nth-child(3) td:first-child .cell .table_num{
		...
		// content kuang1.png
		content: url(../assets/images/kuang1.png);
		margin-right: 10px;
		}
		.el-select-dropdown.is-multiple .el-select-dropdown__item.selected:before{
			position: static;
			content: url(../assets/images/kuang2.png);	
			left: 20px;
			margin-right: 10px;
		}
		// .el-select-dropdown__item span{
