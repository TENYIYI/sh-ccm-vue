<template>
	<div class="mainbody_repro">
		<!--<Header></Header>-->
		<!--传播关闭记录头部操纵start-->
		<div class="serach_bar_repro">
			<div class="title">
				<span>传播监测</span>
			</div>
			<div class="choose_time_repro">
				<span>传播时间</span>
            ...
            <div class="name_list">
                <span>黑白名单</span>
                <el-select v-model="value1" multiple placeholder="黑名单媒体">
		...
		<div class="serach_content">
			...
			<el-table :data="tableData" stripe style="width: 100%">
				<el-table-column prop="num" label="序号" min-width="15.8%"></el-table-column>
				<el-table-column prop="title" label="传播媒体" min-width="20%"></el-table-column>
				<el-table-column prop="media" label="传播媒体域名" min-width="22.5%"></el-table-column>
				<el-table-column prop="user" label="传播文章数" min-width="23.3%"></el-table-column>
				<el-table-column prop="closeTime" label="传播次数" min-width="18.5%"></el-table-column>
			</el-table>
			<!--查询解决表格end-->
			<!--分页start-->
			...
			<div class="remarks">
				<i></i>
				<span>备注:</span>
				<span>传播文章数表示传播的原创文章数，同一篇文章传播2次记为1次。传播次数表示传播的原创文章次数，同一篇文章传播2次记为2次。</span>
			</div>
			<!--备注end-->
		</div>
		<!--传播关闭记录内容end-->
